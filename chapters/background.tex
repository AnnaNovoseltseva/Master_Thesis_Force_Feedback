...
\begin{figure}[h]%
\centering
\subfigure[No communication delay]{%
\label{fig:no_del}%
\includegraphics[width=100mm]{fig/background/meli_no_delay.png}}%
\qquad
\subfigure[With communication delay of 20 ms]{%
\label{fig:with_del}%
\includegraphics[width=100mm]{fig/background/meli_with_delay.png}}
