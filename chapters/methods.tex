...
\label{sec:mechDes}
	...
	• Single grid for unidirectional force measurements;
...
Maximum strain of created device is  0.46 mm, in case of 10N load with maximally opened shaft. From the literature, strain gauges length should be more than 5% of maximum strain, hence, minimum length of the strain gauge should be 9.2 mm. 
