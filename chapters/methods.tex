...
This chapter describes mechanical design of two sensors, one for measurement X-Y component of the forces, another for Z-component of the forces. 
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=80mm]{fig/methods/xy_device_photo.png}
	\end{center}
	\vspace{-4mm}
	\caption[X-Y Device]
	{X-Y Device Photo}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=80mm]{fig/methods/z_device_photo.png}
	\end{center}
	\vspace{-4mm}
	\caption[Z Device]
	{Z Device Photo}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=100mm]{fig/methods/z_dir_color.png}
	\end{center}
	\vspace{-4mm}
