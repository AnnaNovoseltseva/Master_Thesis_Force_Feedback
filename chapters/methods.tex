...
\begin{figure}[h]
	\begin{center}
	\includegraphics[width=100mm]{fig/results/force_pred_x.pdf}
	\end{center}
	\vspace{-4mm}
	\caption[Calibration Results in X-direction]
	{Calibration Results in X-direction}
...
\begin{figure}[h]
	\begin{center}
	\includegraphics[width=100mm]{fig/results/force_pred_y.pdf}
	\end{center}
	\vspace{-4mm}
	\caption[Calibration Results in Y-direction]
