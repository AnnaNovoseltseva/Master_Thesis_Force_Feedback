...
\end{equation}
	...
	The calibration of the load cell is part of the calibration process of the developed device. The setup for load cell calibration is shown on Figure \ref{fig:Calib_setup_LC}.
