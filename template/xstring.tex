...
% -------------------------------------------------------------------
\def\xstringversion     {1.6}
\def\xstringdate        {2012/10/24}
\def\xstringfrenchdate  {24 octobre 2012}
\def\xstringenglishdate {October $24^{\mathrm{th}}$ 2012}
...
\begingroup% on ouvre un groupe o\`u...
	\catcode\z@12 % ...le caract\`ere 0 a 12 pour catcode
	\gdef\tokenize#1#2{%
		\begingroup
...
\@xs@newmacro*3\StrCut{1}{2}{0}{%
	\@xs@testempty{#3}%
	\if@xs@empty\expandafter\@firstoftwo\else\expandafter\@secondoftwo\fi
		{\let\groupID\@empty
		\let\@xs@reserved@C\@empty
...
\def\@xs@StrCut@iii#1#2{\let#1\@xs@reserved@C\let#2\@xs@reserved@E}
